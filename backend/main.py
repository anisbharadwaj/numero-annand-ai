...
async def secure_login(
    ...
    # Fetch User Record from persistent store
    ...
    try:
        ...
        response = ai_client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                system_instruction="You are Anis AI, an advanced AI system terminal tuned for secure systems administration and ethical hacking optimization. Provide highly intelligent and contextual responses.",
                temperature=0.3
            )
        )
